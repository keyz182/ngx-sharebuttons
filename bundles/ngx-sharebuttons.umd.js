...
}(this, (function (exports,_angular_core,_angular_common_http,_angular_common,rxjs_Observable) { 'use strict';
...
var FacebookButton = (function () {
    ...
    FacebookButton.prototype.count = function (url) {
        return this.http.get(this.prop.countUrl + url)
            ...
            .catch(function (err) { return rxjs_Observable.Observable.empty(); });
    };
...
var CopyButton = (function () {
    ...
    CopyButton.prototype.copyURLToClipboard = function (url, directive) {
        ...
        rxjs_Observable.Observable.of({}).take(1).do(function () {
...
var BUTTONS_META = new _angular_core.InjectionToken('BUTTONS_META');
...
ShareButtonsService.ctorParameters = function () { return [
    ...
    { type: undefined, decorators: [{ type: _angular_core.Inject, args: [OPTIONS,] },] },
    { type: undefined, decorators: [{ type: _angular_core.Inject, args: [BUTTONS_META,] },] },
]; };
/**
 * Simple object check.
 * @param {?} item
...
var ShareButtonDirective = (function () {
    ...
    function ShareButtonDirective(share, renderer, cd, el, universal) {
         ...
         * Share count event
         */
        this.sbCount = new _angular_core.EventEmitter();
        /**
         * Share dialog opened event
         */
        this.sbOpened = new _angular_core.EventEmitter();
        /**
         * Share dialog closed event
         */
        this.sbClosed = new _angular_core.EventEmitter();
...
ShareButtonDirective.propDecorators = {
    'sbTitle': [{ type: _angular_core.Input },],
    'sbDescription': [{ type: _angular_core.Input },],
    'sbImage': [{ type: _angular_core.Input },],
    'sbTags': [{ type: _angular_core.Input },],
    'createButton': [{ type: _angular_core.Input, args: ['shareButton',] },],
    'sbUrl': [{ type: _angular_core.Input },],
    'gaTracking': [{ type: _angular_core.Input },],
    'sbCount': [{ type: _angular_core.Output },],
    'sbOpened': [{ type: _angular_core.Output },],
    'sbClosed': [{ type: _angular_core.Output },],
        ...
        return {
            ...
            providers: [
                ...
                { provide: BUTTONS_META, useValue: buttonsMeta },
                {
                    ...
                    deps: [_angular_common_http.HttpClient, OPTIONS, BUTTONS_META]
                }
            ]
        };
    };
...
var ShareButtonComponent = (function () {
    ...
    function ShareButtonComponent(cd, share) {
         ...
         * Share count event
         */
        this.count = new _angular_core.EventEmitter();
        /**
         * Share dialog opened event
         */
...
ShareButtonComponent.propDecorators = {
    'createButton': [{ type: _angular_core.Input, args: ['button',] },],
    'setUrl': [{ type: _angular_core.Input, args: ['url',] },],
    'title': [{ type: _angular_core.Input },],
    'description': [{ type: _angular_core.Input },],
    'image': [{ type: _angular_core.Input },],
    'tags': [{ type: _angular_core.Input },],
    'showIcon': [{ type: _angular_core.Input },],
    'showName': [{ type: _angular_core.Input },],
    'size': [{ type: _angular_core.Input },],
    'setShowCount': [{ type: _angular_core.Input, args: ['showCount',] },],
    'setTheme': [{ type: _angular_core.Input, args: ['theme',] },],
    'buttonClass': [{ type: _angular_core.HostBinding, args: ['class',] },],
    'count': [{ type: _angular_core.Output },],
    'opened': [{ type: _angular_core.Output },],
    'closed': [{ type: _angular_core.Output },],
    'shareDirective': [{ type: _angular_core.ViewChild, args: [ShareButtonDirective,] },],
...
ShareButtonsComponent.propDecorators = {
    'include': [{ type: _angular_core.Input, args: ['include',] },],
    'exclude': [{ type: _angular_core.Input, args: ['exclude',] },],
    'setShownButtons': [{ type: _angular_core.Input, args: ['show',] },],
    'setUrl': [{ type: _angular_core.Input, args: ['url',] },],
    'title': [{ type: _angular_core.Input },],
    'description': [{ type: _angular_core.Input },],
    'image': [{ type: _angular_core.Input },],
    ...
    'setShowCount': [{ type: _angular_core.Input, args: ['showCount',] },],
    'setTheme': [{ type: _angular_core.Input, args: ['theme',] },],
    'containerClass': [{ type: _angular_core.HostBinding, args: ['class',] },],
    'count': [{ type: _angular_core.Output },],
    'opened': [{ type: _angular_core.Output },],
    'closed': [{ type: _angular_core.Output },],
    'shareComponents': [{ type: _angular_core.ViewChildren, args: [ShareButtonComponent,] },],
};
